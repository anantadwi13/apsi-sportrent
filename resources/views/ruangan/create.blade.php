                ...
                <form role="form" method="POST" action="{{route('ruangan.store')}}">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control{{ $errors->has('nama') ? ' is-invalid' : '' }}" id="namaRuangan" name="nama" placeholder="Nama Ruangan" value="{{old('nama')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control{{ $errors->has('kode') ? ' is-invalid' : '' }}" id="kodeRuangan" name="kode" placeholder="Opsional" value="{{old('kode')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control{{ $errors->has('alamat') ? ' is-invalid' : '' }}" id="alamatRuangan" name="alamat" placeholder="Opsional" value="{{old('alamat')}}">
